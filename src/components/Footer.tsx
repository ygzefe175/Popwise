                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
                    <div className="col-span-2">
                        ...
                        <div className="flex gap-4">
                            <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition-colors cursor-pointer">𝕏</div>
                            <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 transition-colors cursor-pointer">in</div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-slate-400">
                            ...
                            <li><Link href="/contact" className="hover:text-brand-orange transition-colors">İletişim</Link></li>
                            <li><Link href="/status" className="hover:text-brand-orange transition-colors">Sistem Durumu</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-slate-400">
                            <li><Link href="#" className="hover:text-brand-orange transition-colors">Gizlilik Politikası</Link></li>
                            <li><Link href="#" className="hover:text-brand-orange transition-colors">Kullanım Şartları</Link></li>
                            <li><Link href="#" className="hover:text-brand-orange transition-colors">Çerez Politikası</Link></li>
                        </ul>
                    </div>
                </div>

                <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-slate-500 text-sm">© 2024 PoopUp Platform. Tüm hakları saklıdır.</p>
